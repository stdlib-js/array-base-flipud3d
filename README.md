...
```javascript
import flipud3d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flipud3d@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-flipud3d/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/array-base-flipud3d/actions/workflows/test.yml?query=branch:v0.1.0
